...
import { PostReadTracker, createPostReadGeometry, } from './postReadTracker';
const geometry = (height, top = 0, viewportHeight = 800) => createPostReadGeometry({ top, height }, 0, viewportHeight);
