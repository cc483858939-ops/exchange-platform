...
const textareaValue = (wrapper) => (wrapper.get('.reply-composer__textarea').element.value);
...
describe('PostDetailView persistent reply drafts', () => {
    ...
    beforeEach(() => {
        ...
        mocks.getPostById.mockImplementation((id) => Promise.resolve(post(Number(id))));
