...
const reply = (overrides = {}) => canonicalPost({
    id: 101,
    content: 'Reply body',
    author: {
        id: 7,
...
describe('PostDetailView post-first surface', () => {
    ...
    it('renders primary and active-reference media with the shared grid', async () => {
        const reference = {
            ...
            media: [{ type: 'image', url: '/reference.png', position: 0 }],
        };
    ...
    it('opens primary, reference, and reply media in the shared viewer', async () => {
        const primaryMedia = [
            { type: 'image', url: '/primary-1.png', position: 0 },
            { type: 'image', url: '/primary-2.png', position: 1 },
        ];
        const referenceMedia = [
            { type: 'image', url: '/reference-1.png', position: 0 },
            { type: 'image', url: '/reference-2.png', position: 1 },
            { type: 'image', url: '/reference-3.png', position: 2 },
            { type: 'image', url: '/reference-4.png', position: 3 },
        ];
        const replyMedia = [
            { type: 'image', url: '/reply-1.png', position: 0 },
            { type: 'image', url: '/reply-2.png', position: 1 },
        ];
        const reference = {
            id: 9,
            deleted: false,
