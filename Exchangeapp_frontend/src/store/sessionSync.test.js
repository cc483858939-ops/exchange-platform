...
import { registerHomeTimelineSync, registerConnectionsSessionSync, registerHistorySessionSync, registerProfileSessionSync, registerSearchSessionSync, syncExternalPostLikeState, syncExternalPostRemoval, syncExternalReplyCount, syncExternalFollowState, syncHomeAuthorIdentity, syncHomeLikeState, syncProfileAuthorIdentity, syncProfileFollowState, syncProfileLikeState, } from './sessionSync';
const likeUpdate = {
    postId: 42,
    likes: 9,
    liked: true,
