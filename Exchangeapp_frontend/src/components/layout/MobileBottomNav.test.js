...
const mocks = vi.hoisted(() => ({
    authStore: null,
    route: null,
    homeTimeline: { activeTab: 'for-you' },
    searchSession: { query: '' },
}));
vi.mock('../../store/auth', () => ({
...
const mountNav = (notificationBadge = null) => mount(MobileBottomNav, {
...
const dispatchClick = (wrapper, index, init = {}) => {
...
const setState = (isAuthenticated, routeName = 'Home', params = {}) => {
