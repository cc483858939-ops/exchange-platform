...
describe('performance scenario config', () => {
    it('parses orchestration identity and every scenario field', () => {
        expect(parsePerfScenarioConfig('?scenario=1&suiteId=suite-1&runId=run-2&viewport=mobile&width=392&height=840'
            + '&count=100&trackView=false&fixture=text-only&runType=append&appendFrom=80')).toEqual({
            suiteId: 'suite-1',
            runId: 'run-2',
            viewport: 'mobile',
            width: 392,
