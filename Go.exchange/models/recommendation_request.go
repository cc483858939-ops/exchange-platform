...
type RecommendationRequest struct {
	...
	ExplorationTargetCount      int       `json:"exploration_target_count" gorm:"not null;default:0;check:chk_recommendation_request_exploration_target,exploration_target_count >= 0 AND exploration_target_count <= requested_limit"`
	ExplorationOpportunityCount int       `json:"exploration_opportunity_count" gorm:"not null;default:0;check:chk_recommendation_request_exploration_opportunity,exploration_opportunity_count >= 0 AND exploration_opportunity_count <= exploration_target_count"`
	ExplorationResultCount      int       `json:"exploration_result_count" gorm:"not null;default:0;check:chk_recommendation_request_exploration_result,exploration_result_count >= 0 AND exploration_result_count <= exploration_opportunity_count AND exploration_result_count <= result_count"`
