...
var curatedV1Accounts = map[string]SourceAccount{
	...
	"laozhouhengmei":  {Key: "laozhouhengmei", Platform: "x", Handle: "laozhouhengmei", Category: "business_creator"},
	"JamesAI":         {Key: "JamesAI", Platform: "x", Handle: "JamesAI", Category: "business_creator"},
	"Svwang1":         {Key: "Svwang1", Platform: "x", Handle: "Svwang1", Category: "business_creator"},
